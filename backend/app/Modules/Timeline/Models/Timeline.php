...
class Timeline extends Model
{
    ...
    protected static ?string $factory = TimelineFactory::class;
    ...
    {
        static::creating(function (Timeline $timeline): void {
    ...
    {
        return $this->hasMany(TimelineTask::class, 'timeline_id');
    }
